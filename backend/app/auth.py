...
# Configuration
SECRET_KEY = os.getenv("JWT_SECRET_KEY", os.getenv("SECRET_KEY", "dev-secret-key-change-in-production-min-32-chars"))
ALGORITHM = "HS256"
...
def verify_token(token: str) -> Optional[Dict[str, Any]]:
    """Verify JWT token and return payload with expiration check"""
    try:
    ...
    try:
        ...
        if onboarding_data:
            survey = OnboardingSurvey(
                ...
                age_grade_level=onboarding_data.get('age_grade_level'),
                learning_notes=onboarding_data.get('learning_notes')
